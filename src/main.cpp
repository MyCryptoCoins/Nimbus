...
const string strMessageMagic = "Nimbus Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Nimbus", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Nimbus first hash for this fair coin";
        CTransaction txNew;
        txNew.nTime = 1408215674; //Sat, 16 Aug 2014 19:01:14 GMT
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1408215674; //Sat, 16 Aug 2014 19:01:14 GMT
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x5818cf36fbb675c83a5a340fe625603527e538940f5c63423bb515781813dce3"));
		block.print();
